...
//                     def hasil = result.split(",")
                    ...
                    def hasils = resulthtml.split(/[\{\}\[\]]/)
                
                        for (hasil in hasils) {
                            def subhasils = hasil.split(/[,]/)
                            echo "result ke ${hasil} ${hasils[hasil]}" 
                            for (subhasil in subhasils) {
                                echo "sub result ke ${subhasil} ${subhasils[subhasil]}" 
                            }
                        }
